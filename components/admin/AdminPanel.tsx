      ...
      supabase.channel(`admin-${table}`)
        .on('postgres_changes', { event: 'INSERT', schema: 'public', table }, (payload) => {
          ...
          if ('Notification' in window && Notification.permission === 'granted') {
            new Notification('Pesanan Baru Masuk! ðŸŽ‰', {
                        ...
                        <td className="p-4">
                          <div className="flex gap-1">
                            ...
                            <button onClick={() => setEditProduct(p)}
                              className="p-1.5 rounded-lg text-[#00c896] hover:bg-[#00c896]/10 transition-colors">
                              <Pencil className="w-3.5 h-3.5" />
                            </button>
                            <button onClick={() => setDeleteProduct(p)}
                              className="p-1.5 rounded-lg text-[#f87171] hover:bg-red-500/10 transition-colors">
